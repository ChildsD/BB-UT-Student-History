...
//                     */
    ...
    public String getLetterGrade(Id userID) throws PersistenceException
    {
    	ScoreDbLoader scoreLoader = (ScoreDbLoader)getBbPm().getLoader(ScoreDbLoader.TYPE);
    	return scoreLoader.loadByCourseMembershipId(userID).toString();
    }


	public StaffInfo getFacultyInfo(User instructor) throws KeyNotFoundException, PersistenceException {
		StaffInfoDbLoader staffLoader = StaffInfoDbLoader.Default.getInstance();
		StaffInfo result = staffLoader.loadById(instructor.getId());
		return result;
	}
